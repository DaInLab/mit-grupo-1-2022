...
names(vacinado) <- c("Sim, duas doses ou dose unica", 
                     "Sim, duas doses, dose unica e reforco", 
                     "Sim, completamente duas doses ou dose unica", 
                     "Sim, duas dose ou dose unica e doses reforco")
vacinado
...
grafico_ies_reinicio <- pie(ies_reinicio,
                         ...
                         main = "Gráfico 11: Reinício das atividades presenciais ")
```
...
grafico_migrou_virtual <- pie(migrou_virtual,
                           ...
                           main = "Grafico 15: Migrou Virtual ")
```
...
grafico_capacidade_prosseguir_estudos <- pie(capacidade_prosseguir_estudos,
                               ...
                               main = "Grafico 18 : Prosseguimento aos estudos antes e durante a pandemia ",
                              cex.main=0.8)
